...
const KPICards = () => {
  ...
  return (
    <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-5">
      <div className="bg-card p-6 rounded-xl shadow-lg border border-border hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
      ...
      <div className="bg-card p-6 rounded-xl shadow-lg border border-border hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
        ...
        <h3 className="text-2xl font-bold text-foreground">{totalTopics}</h3>
      ...
      <div className="bg-card p-6 rounded-xl shadow-lg border border-border hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
        ...
        <h3 className="text-2xl font-bold text-foreground">{totalSkills}</h3>
      ...
      <div className="bg-card p-6 rounded-xl shadow-lg border border-border hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
        ...
        <h3 className="text-2xl font-bold text-foreground">{avgSkillsPerUser}</h3>
        <p className="text-muted-foreground text-sm">Skills per User</p>
      </div>
      ...
      <div className="bg-card p-6 rounded-xl shadow-lg border border-border hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
        ...
        <h3 className="text-2xl font-bold text-foreground">{totalTopics}</h3>
        <p className="text-muted-foreground text-sm">Topics Covered</p>
      </div>
    </div>
  );
};
